...
const AITools = () => {
  ...
  const aiTools = [
    ...
    },
    {
      ...
      category: 'communication',
      description: 'Built-in ASL alphabet (A–Z) recognition with normalized hand landmarks. Start your camera for automatic letter detection, confidence scoring, and transcript building.',
      features: ['ASL A–Z letters', 'Auto-start on camera', 'Normalized landmark model', 'Text-to-speech & transcript'],
